...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('projects', function (Blueprint $table) {
            ...
            $table->foreignId('responsible_person_id')->constrained(table: 'partners', indexName: 'projects_responsible_person_id_foreign');
            $table->foreignId('defendant_id')->nullable()->constrained(table: 'partners', indexName: 'projects_defendant_id_foreign');
